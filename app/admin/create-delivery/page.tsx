    ...
    try {
      ...
      for (let i = 0; i < bulkDropoffs.length; i++) {
        ...
        await addDoc(collection(db, "payments"), {
          ...
          deliveryId: docRef.id,
          gateway: "Manual",
          gatewayResponse: "Admin Bulk Entry",
          paidAt: Timestamp.now(),
                ...
                <Card className="border shadow-none rounded-2xl overflow-hidden hover:border-border transition-all">
                  ...
                  <CardContent className="pt-6 space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="single-fee">Delivery Fee (â‚¦)</Label>
                        <Input
                          id="single-fee"
                          type="number"
                          placeholder="0.00"
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center pt-2">
                        ...
                        <span className="text-xl font-bold text-primary">
                          â‚¦{(Number(singleFee) || 0).toLocaleString()}
                        </span>
                      </div>
                    </div>
