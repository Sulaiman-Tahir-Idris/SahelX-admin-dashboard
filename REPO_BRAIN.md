...
| 2026-09-11 | Antigravity | Refactored Firebase Functions to v2 API, added secure Paystack wallet top-up flow with initializePaystackTransaction and paystackCallback, built WalletTransactions ledger, and restructured functions codebase. |
| 2026-09-11 | Antigravity | Implemented in-app wallet refund button for cancelled deliveries, built onDeliveryStatusChanged automated push notifications, created sendAdminNotification broadcast Cloud Function, and wired Admin Push Notification composer in Firebase Settings. |
