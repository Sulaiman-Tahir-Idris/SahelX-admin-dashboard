...
import { type CourierUser } from "@/lib/firebase/users";
...
export function RiderRegistrationForm() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    try {
      ...
      // Formally define the object to satisfy TypeScript and remove unused warnings
      const newRider: Partial<CourierUser> & { password?: string } = {
        userId: riderId,
        ...
        vehicleInfo: {
          ...
          plateNumber: "", // Default or add to form
          model: "",
          color: "",
      ...
      <div className="space-y-6">
        ...
        <Card className="border-green-200 bg-green-50 dark:border-green-800 dark:bg-green-950">
          ...
          <CardContent className="space-y-4">
            <Alert>
              <AlertDescription>
                The rider has been successfully registered. Share these
                credentials with the rider so they can log into their SahelX
                Rider Mobile App.
              </AlertDescription>
            </Alert>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button
                      size="sm"
                      variant="outline"
                      onClick={() => copyToClipboard(riderCredentials.riderId)}
                    >
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button
                      size="sm"
                      variant="outline"
                      onClick={() => copyToClipboard(riderCredentials.email)}
                    >
                      <Copy className="h-4 w-4" />
                    </Button>
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button
                      size="sm"
                      variant="outline"
                      onClick={() => copyToClipboard(riderCredentials.password)}
                    >
                      <Copy className="h-4 w-4" />
                    </Button>
                  </div>
            ...
            <div className="rounded-lg border bg-blue-50 p-4 dark:bg-blue-950">
              ...
              <p className="text-sm text-blue-700 dark:text-blue-300">
                The rider will use these credentials to log into the SahelX
                Rider Mobile App. Make sure they have the app installed on their
                mobile device before sharing these credentials.
              </p>
            </div>

            <Alert>
              <AlertDescription>
                <strong>Important:</strong> These credentials are for the SahelX
                Rider Mobile App only. The rider should download the mobile app
                and use these credentials to log in. They should change their
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-muted-foreground">
            Register a new rider to the SahelX platform. Login credentials will
        ...
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        This will be used as the rider's login email
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
                      ...
                      <FormDescription>
                        Mark this rider as verified. Verified riders can start
                        accepting deliveries immediately.
                      </FormDescription>
                    </div>
                    <FormControl>
                      <Switch
              ...
              <Alert>
                <AlertDescription>
                  After registration, login credentials (email and temporary
                  password) will be generated automatically. Please share these
                  credentials with the rider so they can access the Rider App.
                </AlertDescription>
              </Alert>
