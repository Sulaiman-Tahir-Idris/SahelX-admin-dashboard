  ...
  return (
    <Card className="col-span-full">
      ...
      <CardContent>
        ...
        <div className="relative h-[500px] w-full rounded-lg border bg-muted/20 overflow-hidden">
          ...
          {/* Map overlay info */}
          <div className="absolute bottom-4 left-4 rounded-lg bg-white/90 p-3 shadow-lg dark:bg-black/90">
          ...
          {/* Legend */}
          <div className="absolute bottom-4 right-4 rounded-lg bg-white/90 p-3 shadow-lg dark:bg-black/90">
