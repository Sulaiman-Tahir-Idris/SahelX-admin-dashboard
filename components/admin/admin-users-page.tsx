        ...
        <Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Create a new administrator account with full access to the
                dashboard.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4">
              ...
              <Alert>
                <AlertDescription>
                  The new admin will have the same permissions as you and will
                  be able to access all dashboard features.
                </AlertDescription>
              </Alert>
            </div>
