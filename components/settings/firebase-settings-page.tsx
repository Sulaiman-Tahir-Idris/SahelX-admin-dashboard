  ...
  return (
    <div className="space-y-6">
      <Alert>
        ...
        <AlertDescription>
          These settings control the core functionality of your SahelX delivery platform. Changes will affect all new
          ...
          <Card>
            <CardHeader>
              ...
              <p className="text-sm text-muted-foreground">
                Configure the pricing structure for deliveries. These rates will be used to calculate delivery fees.
              </p>
            </CardHeader>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Define the geographical areas where SahelX provides delivery services.
                </p>
              </div>
        ...
        <TabsContent value="notifications" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <p className="text-sm text-muted-foreground">Customize the messages sent to customers and couriers.</p>
            </CardHeader>
            <CardContent>
              <Alert>
                <AlertDescription>
                  Notification template management will be implemented in the next phase. Default templates are
                  currently in use.
                </AlertDescription>
              </Alert>
            </CardContent>
        ...
        <TabsContent value="system" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <p className="text-sm text-muted-foreground">System-level settings and maintenance tools.</p>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-4">
                <div className="p-4 border rounded-lg">
                  <h4 className="font-medium mb-2">Initialize Default Settings</h4>
                  <p className="text-sm text-muted-foreground mb-3">
                    Reset all settings to default values. This will overwrite any existing settings.
                  </p>
                  <Button onClick={handleInitializeSettings} disabled={isInitializing} variant="outline">
                    {isInitializing ? (
                      <>
                        <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                        Initializing...
