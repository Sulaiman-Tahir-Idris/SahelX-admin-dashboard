content = """
// Mix of v1 (for existing function) and v2 (for new functions)
...
// ─── Chat Notification (kept as v1 — already deployed, cannot upgrade in-place) ──
...
// ─── Server-side Paystack Verification (v2) ───────────────────────────────────
