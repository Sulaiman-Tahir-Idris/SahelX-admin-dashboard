...
export const createAdminUser = async (
  ...
  try {
    ...
    const rolePermissions: Record<string, string[]> = {
      ...
      ceo: ["read", "write", "delete", "manage_users", "manage_settings"],
      cto: ["read", "write", "delete", "manage_users", "manage_settings"],
      cfo: ["read", "view_finances", "manage_finances"],
      coo: [
        "read",
        "manage_riders",
        "manage_deliveries",
        "manage_multiple_deliveries",
      ],
    };
